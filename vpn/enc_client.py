...
while True:
  ...
  for fd in ready:
    if fd is sock:
       ...
       os.write(tun, decrypted_data) #arriva al livello applicativo tutto il pacchetto con gli header, inviamolo allora al routing cosi che quando risale per la network interface vera vengano tolti gli headrer
    ...
    if fd is tun:
       ...
       sock.sendto(encrypted_data, ('10.0.7.11', 9090))
